...
import falasImg from "../assets/falas.png";
import Fala1 from "../assets/fala-1.png";
import Fala2 from "../assets/fala-2.png";
...
const Falasteen = () => {
  const hotelFeatures = ["حوالي 10 دقائق مشيا", "بدون توصيل مجاني"];
  const smallImages = [Fala1, Fala2];
