...
import Diy1 from "../assets/diy-1.png";
import Diy2 from "../assets/diy-2.png";
import Diy4 from "../assets/diy-4.png";
...
const DiyafahRajaa = () => {
  const hotelFeatures = ["حوالى 10 دقائق مشيا", "بدون توصيل مجانا"];
  const smallImages = [Diy1, Diy2, Diy4];
